...
public class UIManager : MonoBehaviour
{
    ...
    {
        manager.GetComponent<DatasetReader>().ReadFile("Assets/Databases/carros_teste.csv");
        genVizD.GetComponent<VisualizationManager>().datasetname = "carros_teste";
        genVizF.GetComponent<VisualizationManager>().datasetname = "carros_teste";
        SetNewDatabase();
    }
