...
public class AreaChart : DefaultTrackableEventHandler
{
    ...
    private void SetDefaultAxis()
    {
        ...
        {
            if ((cat == 1) && ((datasetTypeOfAtt[i] == "CAT")))
            {
        ...
        this.transform.GetChild(0).GetComponent<AR_ChartGenerator>().GetChart(serverPath, datasetName, default_X, default_Y, default_Z, "areachart",
