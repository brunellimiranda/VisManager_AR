...
public class LineChart : DefaultTrackableEventHandler
{
    ...
    private void SetDefaultAxis()
    {
        ...
        this.transform.GetChild(0).GetComponent<AR_ChartGenerator>().GetChart(serverPath, datasetName, default_X, default_Y, default_Z, "linechart",
